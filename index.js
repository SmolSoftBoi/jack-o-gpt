...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const voiceData = yield captureVoiceInput();
            const text = yield transcribeVoiceToText(voiceData);
            const processedText = yield interactWithAssistant(text);
            if (processedText) {
                const voiceOutput = yield convertTextToVoice(processedText);
...
function initializeMicrophone() {
    return node_record_lpcm16_1.default.record({
        sampleRate: 16000,
        threshold: 0.5,
        endOnSilence: true,
        silence: '1.0',
...
function setupMicrophoneStream(mic) {
    mic.stream()
        .on('end', main)
        .on('error', handleError)
        .pipe(fs_1.default.createWriteStream('audioData.wav'));
}
function captureVoiceInput() {
    return __awaiter(this, void 0, void 0, function* () {
        return fs_1.default.createReadStream('audioData.wav');
    });
}
function transcribeVoiceToText(voiceData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function interactWithAssistant(userInput) {
    return __awaiter(this, void 0, void 0, function* () {
        const systemMessage = {
            role: "system",
...
function convertTextToVoice(text) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.post('https://api.elevenlabs.io/v1/text-to-speech/mzqE3wliVNT4R5olfLWv', {
...
function playAudioOutput(filePath, voiceOutput) {
    fs_1.default.writeFileSync(filePath, Buffer.from(voiceOutput));
